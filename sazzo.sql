...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20/02/2024 às 00:02
...
(46, '::1', '2024-02-19 20:01:54', '65d183ed6be3a');

-- --------------------------------------------------------

--
-- Estrutura para tabela `tb_admin.specials`
--
...
--
-- Despejando dados para a tabela `tb_admin.specials`
--
...
--
-- Estrutura para tabela `tb_admin.users`
--
...
--
-- Despejando dados para a tabela `tb_admin.users`
--

INSERT INTO `tb_admin.users` (`id`, `id_google`, `user`, `name`, `password`, `img`, `type_user`) VALUES
...
--
-- Estrutura para tabela `tb_admin.users_google`
--

CREATE TABLE `tb_admin.users_google` (
  `id` int(11) NOT NULL,
  `id_google` varchar(50) NOT NULL,
...
--
-- Despejando dados para a tabela `tb_admin.users_google`
--

INSERT INTO `tb_admin.users_google` (`id`, `id_google`, `email`, `name`, `img`, `type_user`) VALUES
(1, '107633788097541859222', 'sabrinapolazzo406@gmail.com', 'Sabrina Polazzo', '107633788097541859222_profile_picture.jpg', 0);

-- --------------------------------------------------------

--
-- Estrutura para tabela `tb_admin.visits`
--
...
--
-- Despejando dados para a tabela `tb_admin.visits`
--
...
--
-- Estrutura para tabela `tb_site.testimonial`
--
...
--
-- Despejando dados para a tabela `tb_site.testimonial`
--
...
(21, 'Lucas Pereira', 'Recebi meu pedido antes do prazo estipulado e em perfeito estado. Muito satisfeito com a eficiência.', '2024-01-03', 6),
...
--
-- Índices de tabela `tb_admin.specials`
--
ALTER TABLE `tb_admin.specials`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `tb_admin.users`
--
ALTER TABLE `tb_admin.users`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `tb_admin.users_google`
--
ALTER TABLE `tb_admin.users_google`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `tb_admin.visits`
--
ALTER TABLE `tb_admin.visits`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `tb_site.config`
--
...
--
-- Índices de tabela `tb_site.testimonial`
--
...
--
-- AUTO_INCREMENT de tabela `tb_admin.specials`
--
ALTER TABLE `tb_admin.specials`
...
--
-- AUTO_INCREMENT de tabela `tb_admin.users_google`
--
ALTER TABLE `tb_admin.users_google`
...
--
-- AUTO_INCREMENT de tabela `tb_site.testimonial`
--
ALTER TABLE `tb_site.testimonial`
