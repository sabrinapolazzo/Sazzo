...
<form method="post" enctype="multipart/form-data">
    <div class="metricas container text-left bg-main-begePastel p-4 p-4 mb-3 mt-3">
        ...
        ?>
        <h6 class="mb-3"><i class="fa fa-pen-to-square"></i> Editar Depoimentos</h6>
        <div class="mb-3">
            <label for="name" class="form-label">Nome da Pessoa</label>
            <input type="text" id="name" name="name" class="form-control" value="<?php echo $testimonial['name']?>">
        </div>
        <div class="mb-3">
            <label for="testimonial" class="form-label">Depoimento</label>
            <textarea id="testimonial" name="testimonial" class="form-control" cols="30" rows="10" ><?php echo $testimonial['testimonial']?></textarea>
        </div>
        <div class="mb-3">
            <label for="name" class="form-label">Data de atualização</label>
            <input type="date" id="date" name="date" class="form-control" value="<?php echo $testimonial['date']?>">
        </div>
